...
#include "s1_old_smartrf_settings.h"


// TI-RTOS RF Mode Object
RF_Mode RF_prop_s1_old =
{
...
static uint32_t pOverrides_s1_old[] =
{
...
rfc_CMD_PROP_RADIO_DIV_SETUP_t RF_cmdPropRadioDivSetup_s1_old =
{
    .commandNo = 0x3807,
    .status = 0x0000,
    ...
    .txPower = 0x003F,
    .pRegOverride = pOverrides_s1_old,
    .centerFreq = 0x01B1,
    .intFreq = 0x8000,
    .loDivider = 0x0A,
};
...
rfc_CMD_PROP_RX_t RF_cmdPropRx_s1_old =
{
    .commandNo = 0x3802,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
// CMD_PROP_RX_ADV
rfc_CMD_PROP_RX_ADV_t RF_cmdPropRxAdv_preDef_s1_old =
{
    .commandNo = 0x3804,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
rfc_CMD_PROP_TX_t RF_cmdPropTx_s1_old =
{
    .commandNo = 0x3801,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
