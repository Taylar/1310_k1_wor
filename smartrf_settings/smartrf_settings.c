...
static  uint32_t pOverrides_50K[] =
{
...
const rfc_CMD_PROP_RADIO_DIV_SETUP_t RF_cmdPropRadioDivSetup_50K =
{
    .commandNo = 0x3807,
    .status = 0x0000,
    ...
    .formatConf.whitenMode = 0x2, // PN9
    .config.frontEndMode = 0x0,
    .config.biasMode = 0x1,
    .config.analogCfgMode = 0x0,
    .config.bNoFsPowerUp = 0x0,
    .txPower = 0x003F,
    .pRegOverride = pOverrides_50K,
    .centerFreq = 0x01B2,
    .intFreq = 0x8000,
    .loDivider = 0x0A,
};
...
const rfc_CMD_FS_t RF_cmdFs_50K =
{
    .commandNo = 0x0803,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
rfc_CMD_PROP_RADIO_DIV_SETUP_t RF_cmdPropRadioDivSetup =
{
    ...
    //.symbolRate.preScale = 0xF,
    //.symbolRate.rateWord = 0x3333,  //修改为20k的速率
    // .symbolRate.rateWord = 0x4A3D,   //修改为30k的速率
	.symbolRate.preScale = 0xB,
    .symbolRate.rateWord = 0x1C28,  //修改15k的速率
    .rxBw = 0x21,
...
// Overrides for CMD_PROP_RADIO_DIV_SETUP
static uint32_t pOverrides_2_5K[] =
{
    // override_use_patch_simplelink_long_range.xml
    // PHY: Use MCE RAM patch, RFE RAM patch
    MCE_RFE_OVERRIDE(1,0,0,1,0,0),
...
// CMD_PROP_RADIO_DIV_SETUP
// Proprietary Mode Radio Setup Command for All Frequency Bands
rfc_CMD_PROP_RADIO_DIV_SETUP_t RF_cmdPropRadioDivSetup_2_5K =
{
    .commandNo = 0x3807,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
    ...
    .formatConf.bMsbFirst = 0x0,
    .formatConf.fecMode = 0x8,
#ifdef RADIO_TEST_PRO
    .formatConf.whitenMode = 0x0, // PN9
#else
    .formatConf.whitenMode = 0x2, // PN9
#endif
    .config.frontEndMode = 0x0,
...
// CMD_PROP_TX
// Proprietary Mode Transmit Command
rfc_CMD_PROP_TX_t RF_cmdPropTx_2_5K =
{
    .commandNo = 0x3801,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
// CMD_PROP_RX
// Proprietary Mode Receive Command
rfc_CMD_PROP_RX_t RF_cmdPropRx_2_5K =
{
    .commandNo = 0x3802,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
// Overrides for CMD_PROP_RADIO_DIV_SETUP
static uint32_t pOverrides_625[] =
{
